...
contextBridge.exposeInMainWorld('api', {
  ...
  requestConnection: (deviceIp: string, deviceId: string) => ipcRenderer.invoke('request-connection', { deviceIp, deviceId }),
  ...
  uploadFileToWeb: (data: { baseUrl: string; filePath: string }) => ipcRenderer.invoke('upload-file-to-web', data),
  uploadTextToWeb: (data: { baseUrl: string; text: string }) => ipcRenderer.invoke('upload-text-to-web', data),
  uploadFolderToWeb: (data: { baseUrl: string; folderPath: string }) => ipcRenderer.invoke('upload-folder-to-web', data),
